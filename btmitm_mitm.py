...
class Btmitm():
    ...
    def do_mitm(slave_sock, service, master_adaptor):
    ...
    def setup_mitm(target_slave, target_master, **kwargs):
        ...
        try:
            ...
            print 'Now connect to the spoofed slave from the master device'
